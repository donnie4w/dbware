...
{
    public final static String XML_CONFIG_RSRC_PATH     = GlobalVar.WORKPATH + GlobalVar.SEP + "conf" + GlobalVar.SEP + "dbServer.xml";
...
//            is = C3P0ConfigUtils.class.getResourceAsStream(XML_CONFIG_RSRC_PATH);
        	File file = new File(XML_CONFIG_RSRC_PATH);
        	is = new FileInputStream(file);
            if ( is == null )
            {
//                warnCommonXmlConfigResourceMisspellings();
                throw new Exception("dbServer.xml load fail!");
//                return null;
            }
            else
